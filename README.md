# CUPL MSJJFXY Notice Watch

[中文说明](README.zh-CN.md)

An unofficial daily archive and static dashboard for public notices from the Civil, Commercial and Economic Law School of China University of Political Science and Law.

![Dashboard demo](assets/demo.svg)

## What It Tracks

- Site: CUPL Civil, Commercial and Economic Law School
- Base URL: `https://msjjfxy.cupl.edu.cn/`
- Notice URL: `https://msjjfxy.cupl.edu.cn/xwygg/tzgg.htm`
- Sections: college notices, with homepage fallback and detail-page date extraction
